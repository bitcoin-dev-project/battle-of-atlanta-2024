...
VERSIONS = [
    ...
    "24.2.0",  # CVE-2024-35202 "blktxn crash" patched by PR #26898 fixed in v25.0
    "23.2.0-with-PR-26898", # CVE-2019-25220 "headers spam" fixed in 24.0.1
    "0.21.1", # CVE-2024-52919 "addr spam" fixed in 22.0
    "0.20.0", # CVE-2020-14198 "IP banlist" fixed in 0.20.1
    "0.19.2", # CVE-2024-52915 "INV DoS" fixed in 20.0
    "0.17.0", # CVE-2024-52914 "orphan handling DoS" fixed in 0.18.0
    "0.16.1", # CVE-2018-17144 "inflation bug and DoS" fixed in 0.16.3
]
...
g = Game("regtest_medium", "regtest")
g.add_nodes(1, len(VERSIONS))
g.add_miner()
g.add_connections()
g.write()
g.write_armada(1)
